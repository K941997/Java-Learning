 ...
 * Set Interface:
 * 		HashSet:
 * 		- Khi nhap 2 gia tri trung nhau thi` se luu 1 gia tri
 * 		- HashSet sap xep lon xon >< TreeSet sap xep co thu tu
 * */

public class RutThamTrungThuongHashSet {
	Set<String> thungPhieuDuThuong = new HashSet<String>();
	
	public RutThamTrungThuongHashSet() {
	...
	public static void main(String[] args) {
		...
		int luaChon = 0;
		RutThamTrungThuongHashSet rutTham = new RutThamTrungThuongHashSet();
		do {
